              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    <a
                      ...
                      className="flex items-center gap-2 text-gray-600 hover:text-vizon-700 transition-colors"
                    >
                      <svg
                        className="w-5 h-5"
                        fill="currentColor"
                ...
                <div>
                  ...
                  <a
                    ...
                    className="text-gray-600 hover:text-vizon-700 transition-colors"
                  >
                    info@meldesign.tr
                  </a>
                </div>
                <div>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-gray-600 hover:text-vizon-700 transition-colors inline-flex items-center gap-2"
                  >
                    <svg
                      className="w-5 h-5"
                      fill="currentColor"
            ...
            <div>
              ...
              <div className="flex justify-end items-center gap-2 mb-2">
                ...
                <a
                  ...
                  title="Google Haritalar'da Yol Tarifi"
                >
                  <svg
                    className="w-5 h-5"
                    viewBox="0 0 24 24"
